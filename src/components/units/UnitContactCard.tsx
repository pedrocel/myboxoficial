...
export function UnitContactCard({ unit, onOpenAgendamento }: Props) {
  ...
  return (
    <div className="bg-card rounded-xl shadow-lg overflow-hidden sticky top-32" data-aos="fade-left">
      ...
      <div className="p-6">
        {unit.telefone && (
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">{unit.telefone}</p>
            </div>
          </div>
        )}
        {unit.email && (
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="font-bold text-foreground">Segunda à Sexta: 06h às 23h</p>
            <p className="font-bold text-foreground">Sábado: 08h às 18h</p>
            <p className="font-bold text-foreground">Domingo: 09h às 15h</p>
          </div>
        </div>
