...
export function UnitCard({ unit }: { unit: Unit }) {
  ...
  return (
    <div className="bg-card rounded-md shadow-sm border border-border overflow-hidden card-hover-effect">
      ...
      <div className="p-4">
        <h3 className="font-bold text-foreground mb-1">{unit.name}</h3>
