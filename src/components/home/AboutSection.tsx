    ...
    <section id="sobre" className="py-20 bg-card">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl font-bold text-foreground mb-4">O QUE É A MY BOX?</h2>
          ...
          <div className="md:w-1/2" data-aos="fade-left">
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Sempre à frente do mercado fitness</p>
              </div>
            </div>
            <div className="flex items-center gap-4 mt-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground">Comunidade</h3>
                <p className="text-muted-foreground">Mais de 50.000 alunos em todo o Brasil</p>
              </div>
            </div>
          </div>
        </div>
