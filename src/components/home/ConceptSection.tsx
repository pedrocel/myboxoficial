...
export function ConceptSection() {
  return (
    <section id="conceito" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl font-bold text-foreground mb-4">ACADEMIA COM CONCEITO DE SHOPPING</h2>
          ...
          <div className="md:w-1/2" data-aos="fade-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              {conceptCards.map((card) => (
                <div key={card.title} className="bg-card p-6 rounded-lg shadow-md hover:shadow-xl transition">
